/* Physical Examination and Health Assessment in Canada 2026 - PEHA Exam Simulator */

const ACCESS_CODE  = "PEHA9000";
const EXAM_SECONDS = 6 * 60 * 60;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "peha2026_exam_state_v1";
...
function renderReviewList(filter) {
  ...
  items.forEach(({ q, given, isCorrect, isSkipped, givenText, correctText }) => {
    ...
    item.innerHTML = `
      <div class="ri-header">
        <div class="ri-num">Q${q.num} &middot; ${domainLabel(q.domain)}</div>
...
function domainLabel(d) {
  const map = {
    "Foundations of Assessment":                                    "Foundations of Assessment",
    "General Survey & Screening":                                   "General Survey & Screening",
    "Regional Examination: Skin & HEENT":                           "Skin & HEENT",
    "Regional Examination: Thoracic & Cardiovascular":              "Thoracic & Cardiovascular",
    "Regional Examination: Abdominal, Musculoskeletal & Neurological": "Abdominal, MSK & Neuro",
    "Genitourinary, Breast & Reproductive":                         "GU, Breast & Reproductive",
    "Lifespan & Population-Specific Assessment":                    "Lifespan Assessment",
